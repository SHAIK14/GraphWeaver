"""
Prompts for the Schema Proposal Agent.

This agent proposes a knowledge graph schema by analyzing approved files
and determining how to transform them into nodes and relationships.
"""

# =============================================================================
# SCHEMA PROPOSAL AGENT PROMPTS
# =============================================================================
...
# Combined prompt for the Schema Proposal Agent
...
# Combined prompt for the Schema Critic Agent
...
# =============================================================================
# SCHEMA COORDINATOR AGENT PROMPTS (Top-level agent)
# =============================================================================
...
- Use the 'run_schema_refinement' tool to produce or update a proposed schema with construction rules.
